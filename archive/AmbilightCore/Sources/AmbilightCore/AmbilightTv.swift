...
public class AmbilightTv: AmbilightTvProtocol, ObservableObject {
    ...
    @Published public var log = "(no log)"
    @Published public var currentState: AmbilightHueMode? = nil
    ...
    public init(config: AmbilightTvConfig?, sessionFac: SessionFactoryProtocol) {
        self.config = config
